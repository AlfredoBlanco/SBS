import {
  ...
  Collapse, Link, List, ListItemButton, ListItemText, ListItemIcon, Divider
} from '@mui/material';
...
import { selectAdmin, logOut } from '../redux/slices/adminSlice';
...
const Home: NextPage = () => {
  ...
  const loggedAdmin: Admin = useSelector(selectAdmin);
